// menubar.js — airgenome JXA 메뉴바 (run.sh heredoc에서 분리)
// 사용: osascript -l JavaScript menubar.js <state_path> <config_path> <settings_js_path>
// 인자 없으면 기본 경로 사용
...
var tmpdir = $.NSTemporaryDirectory().js;
var statePath = tmpdir + 'airgenome-state.json';
var configPath = home + '/.airgenome/config.json';
var settingsJsPath = home + '/Dev/airgenome/settings.js';

// osascript 인자: -l JavaScript menubar.js [state] [config] [settings_js]
if (argv.count >= 5) statePath = $(argv.objectAtIndex(4)).js;
if (argv.count >= 6) configPath = $(argv.objectAtIndex(5)).js;
if (argv.count >= 7) settingsJsPath = $(argv.objectAtIndex(6)).js;
