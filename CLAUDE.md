...
## 할일 (todo)
- "todo", "할일" → `$HOME/Dev/hexa-lang/target/release/hexa $HOME/Dev/nexus/mk2_hexa/native/todo.hexa airgenome` 실행 후 **결과를 마크다운 텍스트로 그대로 출력** (재포맷 금지). "todo 대량" 시 `... airgenome 대량` 으로 실행.
